 ...
 * wired into the real [appScope] swallows the [WCDBKeyUnavailableException]; the DB directory stays
 * empty so the next process retry can re-attempt the key create.
 *
