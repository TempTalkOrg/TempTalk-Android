...
class WCDBJobTableRegistrationTest {
    ...
    /**
     * Sanity check: the binding singleton objects for both models are non-null. This
     * confirms the WCDB annotation processor successfully generated
     * `DBJobSpecModel` and `DBJobConstraintModel` from the models.
     */
    @Test
    fun generated_bindings_are_non_null() {
        assertNotNull(DBJobSpecModel, "DBJobSpecModel must be generated by WCDB compiler")
        assertNotNull(DBJobConstraintModel, "DBJobConstraintModel must be generated by WCDB compiler")
    }
}
