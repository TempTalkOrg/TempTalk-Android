...
class MagicalView @JvmOverloads constructor(
    ...
    fun startNormal(realWidth: Int, realHeight: Int, showImmediately: Boolean) {
        ...
        setOriginParams()
        showNormalMin(targetImageTop.toFloat(), targetEndLeft.toFloat(), targetImageWidth.toFloat(), targetImageHeight.toFloat())
    ...
    fun setViewParams(left: Int, top: Int, originWidth: Int, originHeight: Int, realWidth: Int, realHeight: Int) {
        this.realWidth = realWidth
        this.realHeight = realHeight
    ...
    private fun beginShow(showImmediately: Boolean) {
        if (showImmediately) {
            ...
            valueAnimator.addUpdateListener { animation ->
                ...
                showNormalMin(
                    value, mOriginTop.toFloat(), targetImageTop.toFloat(), mOriginLeft.toFloat(), targetEndLeft.toFloat(),
                    mOriginWidth.toFloat(), targetImageWidth.toFloat(), mOriginHeight.toFloat(), targetImageHeight.toFloat()
                )
            }
    ...
    private fun showNormalMin(
        showImmediately: Boolean, animRatio: Float, startY: Float, endY: Float, startLeft: Float, endLeft: Float,
        startWidth: Float, endWidth: Float, startHeight: Float, endHeight: Float
    ) {
        if (showImmediately) {
