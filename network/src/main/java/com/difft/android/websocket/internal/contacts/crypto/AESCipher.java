...
public final class AESCipher {
  ...
  public static byte[] decrypt(byte[] key, byte[] iv, byte[] ciphertext, byte[] tag) throws InvalidCiphertextException {
    try {
  ...
  public static AESEncryptedResult encrypt(byte[] key, byte[] aad, byte[] requestData) {
    try {
