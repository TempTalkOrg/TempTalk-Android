    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options)
        ...
        try {
            ...
            try {
                ...
                L.w(e, () -> "[Base64] close oos failed");
            }
            try {
                gzos.close();
            } catch (Exception e) {
                L.w(e, () -> "[Base64] close gzos failed");
            }
            try {
                b64os.close();
            } catch (Exception e) {
                L.w(e, () -> "[Base64] close b64os failed");
            }
            try {
                baos.close();
            } catch (Exception e) {
                L.w(e, () -> "[Base64] close baos failed");
            }
        }   // end finally
        ...
        if ((bytes != null) && (bytes.length >= 4) && (!dontGunzip)) {
            ...
            if (java.util.zip.GZIPInputStream.GZIP_MAGIC == head) {
                ...
                try {
                    ...
                    L.w(e, () -> "[Base64] decode gunzip failed");
                    ...
                    try {
                        ...
                        L.w(e, () -> "[Base64] close gzis failed");
                    }
                    try {
                        bais.close();
                    } catch (Exception e) {
                        L.w(e, () -> "[Base64] close bais failed");
                    }
                }   // end finally
    ...
    public static void encodeFileToFile(String infile, String outfile)
        ...
        try {
            ...
            try {
                ...
                L.w(ex, () -> "[Base64] close out failed");
            }
        }   // end finally    
