...
//  }
    ...
    public static boolean canWriteToMediaStore() {
        return Build.VERSION.SDK_INT > 28 || AndroidPermission.INSTANCE.havePermission(ApplicationDependencies.getApplication(), Manifest.permission.WRITE_EXTERNAL_STORAGE).blockingGet();
    }
