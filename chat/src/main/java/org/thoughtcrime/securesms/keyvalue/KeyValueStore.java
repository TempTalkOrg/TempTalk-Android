 ...
 * {@link }, meaning all write should finish barring a native crash
 * or the system killing us unexpectedly (i.e. a force-stop).
 */
public final class KeyValueStore implements KeyValueReader {

    private static final String TAG = L.INSTANCE.tag(KeyValueStore.class);
    ...
    public KeyValueStore(@NonNull KeyValuePersistentStorage storage) {
        this.executor = TTExecutors.newCachedSingleThreadExecutor("signal-KeyValueStore");
    ...
    synchronized void blockUntilAllWritesFinished() {
        ...
        try {
            ...
            L.w(() -> "Failed to wait for all writes.");
        }
    }
    ...
    class Writer {
        ...
        @NonNull
        Writer putBlob(@NonNull String key, @Nullable byte[] value) {
        ...
        @NonNull
        Writer putInteger(@NonNull String key, int value) {
        ...
        @NonNull
        Writer putString(@NonNull String key, String value) {
