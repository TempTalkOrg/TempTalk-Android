...
public class VideoPlayer extends FrameLayout {
    ...
    public void setVideoSource(@NonNull Uri videoSource, boolean autoplay, String poolTag) {
        setVideoSource(videoSource, autoplay, poolTag, 0, 0);
    }

    public void setVideoSource(@NonNull Uri videoSource, boolean autoplay, String poolTag, long clipStartMs, long clipEndMs) {
        if (exoPlayer == null) {
        ...
        mediaItem = MediaItem.fromUri(Objects.requireNonNull(videoSource)).buildUpon()
