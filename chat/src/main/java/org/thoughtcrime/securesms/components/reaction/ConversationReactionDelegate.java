...
public final class ConversationReactionDelegate {
    ...
    public void show(@NonNull Activity activity,
                     ...
                     @NonNull TextChatMessage conversationMessage,
                     boolean isNonAdminInAnnouncementGroup,
                     @NonNull SelectedConversationModel selectedConversationModel) {
        resolveOverlay().show(activity, rootView, conversationMessage, lastSeenDownPoint, isNonAdminInAnnouncementGroup, selectedConversationModel);
    }
    ...
    public @NonNull ChatMessage getMessageRecord() {
        if (!overlayStub.resolved()) {
