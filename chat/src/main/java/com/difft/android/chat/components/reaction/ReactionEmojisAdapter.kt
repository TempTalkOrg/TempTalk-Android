package com.difft.android.chat.components.reaction
...
abstract class ReactionEmojisAdapter(val chatMessage: TextChatMessage) : androidx.recyclerview.widget.ListAdapter<String, ReactionEmojisViewHolder>(
