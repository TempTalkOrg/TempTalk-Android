...
public final class ImageEditorFragment extends Fragment implements ImageEditorHudV2.EventListener, MediaSendPageFragment, TextEntryDialogFragment.Controller {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int baseDimension = Util.isLowMemory(requireContext()) ? 1600 : 2560;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        @ColorInt int blackoutColor = ContextCompat.getColor(requireContext(), com.difft.android.base.R.color.bg1_night);
        if (editorModel == null) {
            switch (mode) {
                case AVATAR_EDIT:
            ...
            EditorElement image = new EditorElement(new UriGlideRenderer(imageUri, false, imageMaxWidth, imageMaxHeight, UriGlideRenderer.STRONG_BLUR, mainImageRequestListener));
